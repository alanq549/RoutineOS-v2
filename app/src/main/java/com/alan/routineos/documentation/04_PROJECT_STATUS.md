...
| EC-RE-015 | Today Execution Surface Refinement | High | Medium | AI Agent | EC-RE-014 | USER_REVIEW_PENDING | PASS. Visual spine unification, card grammar, synthesized ContextFooter, color tokens. |
